...
var modalElement = document.querySelector('#modalElement');
var bigScoreElement = document.querySelector('#bigScoreElement');
...
addEventListener('click', function (event) {
  ...
  projectiles.push(new Projectile(canvas.width / 2, canvas.height / 2, 2, 'red', velocity));
});
...
function spawnEnemies() {
  setInterval(function () {
    ...
    var color = "hsl(".concat(Math.floor(Math.random() * 360 + 1), ", 50%, 50%)");
    ...
    projectiles.forEach(function (projectile, projectileIndex) {
      ...
      if (dist - enemy.radius - projectile.radius < 1) {
        ...
        if (enemy.radius - 10 > 5) {
          ...
          gsap__WEBPACK_IMPORTED_MODULE_1__["default"].to(enemy, {
